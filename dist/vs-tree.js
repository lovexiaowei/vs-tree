...
(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.VsTree = factory());
  ...
  var removeClass = function removeClass(dom) {
    if (!dom) return;
    ...
    return _createClass(Node, [{
      ...
      value: function createNode() {
        ...
        dom.addEventListener('click', function (e) {
          ...
          if (_this.store.multiDrag && (shiftKey || ctrlKey)) {
            if (ctrlKey) {
              _this.store.selectManager.addNode(_this);
            }
            if (shiftKey) {
              _this.store.selectManager.shiftAdd(_this, _this.store.selectedCurrent);
            }
          } else {
            _this.store.selectManager.clear();
          }
        ...
        dom.addEventListener('dblclick', function (e) {
          e.stopPropagation();
          if (_this.store.dblclick) {
            _this.store.dblclick(e, _this);
          }
        }, {
          passive: false
        });
      ...
      key: "setExpandAll",
      value: function setExpandAll(expand, noUpdate) {
        var _this6 = this;
      ...
      value: function createAnimation() {
        ...
        var _transend = function transend() {
          tg.removeEventListener('transitionend', _transend);
          tg.parentNode && tg.parentNode.removeChild(tg);
          tg.removeEventListener('transitionend', _transend);
          _this8.store.update();
        };
        tg.addEventListener('transitionend', _transend);
      ...
      key: "createDraggable",
      value: function createDraggable(dom) {
        var _this9 = this;
        dom.draggable = true;
        dom.addEventListener('dragstart', function (e) {
          e.stopPropagation();
          if (!_this9.store.selectManager.has(_this9)) {
            //如果拖动了，不是多选的项目，那么要清空;
            _this9.store.selectManager.clear();
          }
          _this9.store.dragNode = _this9;
          _this9.store.onDragstart(e, _this9);
          ...
          try {
            ...
            if (e.dataTransfer) {
              ...
              e.dataTransfer.setData('node', JSON.stringify(_this9.data));
            }
          } catch (e) {}
        });
        ...
        dom.addEventListener('dragover', function (e) {
          e.preventDefault();
          if (!_this9.dom || _this9 === _this9.store.dragNode) return;
          var halfH = (_this9.store.itemHeight || 26) / 2;
          var gap = e.clientY - _this9.dom.getBoundingClientRect().top - halfH > 0 ? 1 : -1;
          // console.log(gap);
          // if (gap === this.enterGap) return;
          _this9.store.enterGap = gap;
          removeClass(_this9.dom);
          if (gap === -1) {
            // dropNode.classList.add('vs-drag-over-gap-top')
            _this9.dom.classList.add('vs-drag-over-node-top');
            return;
          }
          if (gap === 1) {
            // dropNode.classList.add('vs-drag-over-gap-bottom')
            _this9.dom.classList.add('vs-drag-over-node-bottom');
            return;
          }
          if (!_this9.isLeaf) {
            _this9.dom.classList.add('vs-drag-enter');
          }
        });
        dom.addEventListener('dragenter', function (e) {
          e.stopPropagation();
          e.preventDefault();
          _this9.store.dropNode && removeClass(_this9.store.dropNode);
          if (_this9.store.dragNode === _this9) {
            // 如果放到自己上面，那么不做处理
            _this9.store.dropNode = null;
            return;
          }
          var dropNode = _this9.dom;
          if (!dropNode) return;
          // const enterGap = onDragEnterGap(e, dropNode)
          var enterGap = _this9.store.enterGap;
          ...
          if (!_this9.store.dropable) return;
        ...
        dom.addEventListener('drop', function (e) {
          var enterGap = _this9.store.enterGap;
          _this9.store.enterGap = '';
          removeClass(_this9.dom);
          removeClass(_this9.store.dropNode);
          e.stopPropagation();
          // this.store.selectManager.clear();
          if (!_this9.store.dropNode) return;
          if (!_this9.store.dropable) return;
          if (_this9.store.canDrop && typeof _this9.store.canDrop === 'function' && _this9.store.canDrop(_this9.store.dragNode, _this9, _this9.store.selectManager.getTrueDrag()) === false) {
            return false;
          }
          // this.store.onDrop(e, this, this.store.dropPostion)
          // console.log(this.store.dragNode,this);
          var dragNode = _this9.store.dragNode;
          if (!dragNode || !_this9.parent) return;
          if (_this9.store.selectManager.list.length) {
            // console.log('has mul  dra22222222g')
            if (_this9.store.selectManager.has(_this9)) {
              return;
            }
            var nodes = _this9.store.selectManager.getTrueDrag();
            nodes.map(function (v) {
              return _this9.handleLastDrop(v, enterGap);
            });
            if (enterGap === -1 && _this9.isLeaf === false) {
              _this9.store.onDrop(e, dragNode, _this9, nodes);
            } else {
              _this9.store.onDrop(e, dragNode, _this9.parent, nodes);
            }
          } else {
            var son = _this9.store.selectManager.dig(dragNode.childNodes || []);
            if (son.indexOf(_this9.id) > -1) {
              return;
            }
            _this9.handleLastDrop(dragNode, enterGap);
            if (enterGap === -1 && _this9.isLeaf === false) {
              _this9.store.onDrop(e, dragNode, _this9, [dragNode]);
            } else {
              _this9.store.onDrop(e, dragNode, _this9.parent, [dragNode]);
            }
      ...
      key: "handleLastDrop",
      value: function handleLastDrop(dragNode, enterGap) {
        ...
        if (dragNode.childNodes) {
          ...
          dragNode.childNodes.map(function (v) {
            if (v.indeterminate === true) {
              v.data.indeterminate = true;
            } else {
              if (v.checked === true) v.data.checked = true;
      ...
      value: function loadData(callback) {
        ...
        var resolve = function resolve() {
          ...
          } else if (_this10.loadingEl) {
            _this10.loadingEl.classList.remove('is-loading');
          }
          if (children.length) {
      ...
      value: function remove() {
        ...
        if (data && data.children) {
          ...
          var childIndex = data.children.findIndex(function (v) {
            return v.id === _this11.data.id;
          });
          if (childIndex > -1) {
  ...
  var Select = /*#__PURE__*/function () {
    ...
    return _createClass(Select, [{
      ...
      value: function addNode(node) {
        var has = this.list.findIndex(function (v) {
          return v.id === node.id;
        });
        if (has === -1) {
          ...
          var son = this.dig(node.childNodes || []);
      ...
      key: "shiftAdd",
      value: function shiftAdd(node, pre) {
        if (!this.list.length) {
          if (pre) {
            //如果有一个选中的数据
            this.list.push(pre);
        ...
        var startIndex = this.store.nodes.findIndex(function (v) {
          return v.id === node.id;
        });
        // let endNode = this.list[this.list.length - 1]
        var endNode = this.list[0];
        if (!endNode) return;
        var endIndex = this.store.nodes.findIndex(function (v) {
        ...
        for (var i = Math.min(startIndex, endIndex); i <= Math.max(endIndex, startIndex); i++) {
          var _node = this.store.nodes[i];
          _node.dom && _node.dom.classList.add('selected');
          this.list.push(_node);
        }
      }
    }, {
      key: "has",
      value: function has(node) {
        var ids = this.dig(this.list);
      ...
      key: "getTrueDrag",
      value: function getTrueDrag() {
        var _this = this;
        var idsMapping = {};
        //先求出当前的多选包含的子集
        this.list.map(function (v) {
          if (v.childNodes && v.childNodes.length) {
            _this.dig(v.childNodes).map(function (id) {
              idsMapping[id] = 1;
            });
          }
        });
        return this.list.filter(function (v) {
          return !idsMapping[v.id];
        });
      }
      ...
      key: "dig",
      value: function dig(nodes) {
        var _this2 = this;
        var son = [];
        nodes.map(function (v) {
          son.push(v.id);
          if (v.childNodes && v.childNodes.length) {
            son.push.apply(son, _toConsumableArray(_this2.dig(v.childNodes)));
          }
        });
        return son;
      }
  ...
  var TreeStore = /*#__PURE__*/function () {
    ...
    return _createClass(TreeStore, [{
      ...
      value: function getSelectedNodes(filter) {
        if (filter) {
  ...
  var Vlist = /*#__PURE__*/function () {
    ...
    return _createClass(Vlist, [{
      ...
      value: function scrollToNode(node) {
        var _this = this;
        if (!node) return;
        var index = this.dataSources.findIndex(function (v) {
          return node === v;
        });
        if (index === -1) {
          ...
          p.map(function (v) {
            return v.setExpand(true);
          });
          index = this.dataSources.findIndex(function (v) {
            return node === v;
          });
          if (index === -1) return;
          setTimeout(function () {
            _this.scrollToOffset(index * _this.estimateSize);
          }, 70);
        } else {
          setTimeout(function () {
            _this.scrollToOffset(index * _this.estimateSize);
  ...
  var Tree = /*#__PURE__*/function () {
    function Tree(selector, ops) {
      ...
      var _ref = ops.virtual || {},
        ...
        minHeight = _ref$minHeight === void 0 ? '0px' : _ref$minHeight;
      // 每一项的高度
    ...
    return _createClass(Tree, [{
      ...
      value: function filter() {
        ...
        this._render(false);
        var tmpData = this.data.map(function (v) {
          return v;
        });
